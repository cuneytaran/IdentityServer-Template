...
namespace UdemyIdentityServer.Client2.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> GetRefreshToken()
        {
            ...
            refreshTokenRequest.ClientId = _configuration["Client2Mvc:ClientId"];//clientid yi alıyoruz.appsettings.json dan secret bilgisini çekiyoruz
            refreshTokenRequest.ClientSecret = _configuration["Client2Mvc:ClientSecret"];//secret key. configuration dan okuyoruz. yani appsettings.json dan.Client1Mvc:ClientSecret=Client1Mvc den ClientSecret e ulaşıyoruz
